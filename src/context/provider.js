...
const insertionSort=()=>{
    ...
    return (
        <Context.Provider
            value={{ arr, setArr,arrSize, setArrSize,speed, setSpeed,colorArr, setColorArr,algorithm, setAlgorithm, start, setStart,bubbleSort,selectionSort,insertionSort}}
        >
            {children}
        </Context.Provider>
    );
